...
!       auxilary:
    ...
    integer,parameter :: FtoV(4,3)=(/1,1,2,1,3,2,3,4,2,4,4,3/)
    ! Face 1 -> Nodes 1 3 2
    ! Face 2 -> Nodes 1 2 4
    ! Face 3 -> Nodes 2 3 4
    ! Face 4 -> Nodes 1 4 3
